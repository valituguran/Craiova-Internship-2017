            ...
            <div ng-controller="userInfo">
                <ul>
                    <li ng-repeat="user in users | limitTo:5 | orderBy:'time':true">
                        <input type="hidden"  type="text"  ng-model="userID"  value="{{user.id}}">
                        <input type="button" value="{{user.firstname}}"   ng-click="accountdetails(userID)"/>
                        ...
                        <br><button ng-click="followfunction(userID)"> Connect</button>
                    </li>
                </ul>
            </div>
        </div>
