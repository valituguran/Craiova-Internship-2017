...
public class SellServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(quantity>0 && quantity <= com.ymens.SellDao.verifyNegativeQuantity(id,pairname)) {
        ...
        else if(quantity < com.ymens.SellDao.verifyNegativeQuantity(id,pairname)){
            System.out.println("error");
        }
        com.ymens.SellDao.sell(id);
